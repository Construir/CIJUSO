	...
	<div class="card">
		  ...
		  <div class="card-header">
			...
			<ul>
				...
				<a href="<?php echo base_url();?>/uploads/Modelo_archivo_facturacion.xlsx"  style="float:right"  name="btn_descargar_modelo_archivo" id="btn_descargar_modelo_archivo" class="btn btn-secondary btn-sm"><img src="<?php echo base_url();?>/imagenes/baseline_cloud_download_white_24dp.png" width="20" height="20" title="Facturar"> Descargar modelo de archivo</a>
		  ...
		  <div class="card-body">
			...
			<div style="border: 1px dashed #4cae4c;text-align: center;" class="col-12">
				<div id="originalInfo_3" class="replacedTxt">
					<img src="<?php echo base_url(); ?>/imagenes/nube_negra.png" width="100" height="100">
				</div>
						...
						<td style="text-align:center;width:8%">
							...
							<div class="form-inline">							
								...
								<button style="margin-left:5%" type="submit" class="btn btn-primary btn-sm">										
									<img src="<?php //echo base_url(); ?>/imagenes/ver.png" width="20" height="20" title="Ver detalle"> 
								</button>							
								-->
								<!--
									<button type="button" class="btn btn-primary btn-sm" onclick="cargar_lote_a_facturar(<?php //echo $importacion['Id']?>)">										
										<img src="<?php //echo base_url(); ?>/imagenes/ver.png" width="20" height="20" title="Ver Lote"> 
									</button>
...
<div class="modal fade" id="modalfacturarlote" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" style="max-width: 1150px !important;" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button> 
		<button type="button" class="btn btn-info"><img src="<?php echo base_url(); ?>/imagenes/impresora_blanca.png" width="20" height="20" title="Imprimir Facturas"> Imprimir Facturados</button>
		<button type="button" class="btn btn-primary"><img src="<?php echo base_url(); ?>/imagenes/baseline_qr_code_scanner_white_24dp.png" width="20" height="20" title="Facturar"> Facturar Pendientes</button>		
      </div>
    </div>
  </div>
</div>
		...
		<div class="modal-body">		
			...
			<div class="form-group">						
				<div class="alert"  role="alert">					
					<div class="form-group">
						<center>
							<img id="img_exito" style="display:none" src="<?php //echo base_url(); ?>/imagenes/hecho.png" width="100" height="100">
							<img id="img_fallo"  src="<?php //echo base_url(); ?>/imagenes/problemas.png" width="80" height="80">
						</center>
						<br>						
